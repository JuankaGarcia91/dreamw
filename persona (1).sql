...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-03-2023 a las 17:31:51
...
INSERT INTO `persona` (`cedula`, `fecha`, `asunto`, `primer_nombre`, `segundo_nombre`, `primer_apellido`, `segundo_apellido`, `fijo`, `celular`, `direccion`, `barrio`, `descripcion`, `pais`, `estado`, `ciudad`) VALUES
(698554, '2015-10-15', 'ruralidad', 'geral', 'daniela', 'penagos', 'rendon', 4708069, '906956765437', 'carrera 17a 6b 21', 'parque', 'parque', '', '', ''),
(869324, '2015-09-05', 'COMERCIAL', 'jorge', 'fenibal', 'arias', 'ramires', 9876897, '987698', 'calle 7 5- 24', 'parque', 'comentario', '', '', ''),
